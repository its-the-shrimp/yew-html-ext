...
pub struct Child;
impl ::yew::html::Component for Child {
    type Message = ();
...
pub struct ChildContainerProperties {
    pub children: ::yew::html::ChildrenWithProps<Child>,
}

pub struct ChildContainer;
impl ::yew::html::Component for ChildContainer {
    type Message = ();
